...
export const Login = () => {
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        alert('user email ' + email + 'password ' + password);
    }
                            ...
                            <div className="divide-y divide-gray-200">
                                <div
                                    ...
                                    <div className="relative">
                                        <input autoComplete="off" id="email" value={email} onChange={(e) => setEmail(e.target.value)} name="email" type="text"
                                    ...
                                    <div className="relative">
                                        <input autoComplete="off" id="password" name="password" value={password} onChange={(e) => setPassword(e.target.value)} type="password"
                                               className="peer placeholder-transparent h-10 w-full border-b-2 border-gray-300 text-gray-900 focus:outline-none focus:borer-rose-600"
