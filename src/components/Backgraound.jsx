   ...
   const [color , setColor] = React.useState('red')
    ...
    return (
        <div className=' w-full h-screen ' style={{backgroundColor: color}}>
            ...
            <div className="fixed flex flex-wrap  justify-end text-center  bottom-12 gap-2 px-2 py-0 rounded-3xl">
                <div className="flex flex-wrap justify-center bottom-12 gap-2 bg-white px-2 py-0 rounded-3xl shadow-lg">
